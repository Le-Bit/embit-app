...
exports.VideoHlsServiceApi = exports.VideoHlsServiceApiFactory = exports.VideoHlsServiceApiFp = exports.VideoHlsServiceApiAxiosParamCreator = void 0;
/* tslint:disable */
/* eslint-disable */
/**
 * Emby Server API
...
/**
 * VideoHlsServiceApi - axios parameter creator
 * @export
 */
const VideoHlsServiceApiAxiosParamCreator = function (configuration) {
    return {
        /**
         ...
         */
        getVideosByIdHlsByPlaylistidBySegmentidBySegmentcontainer: async (playlistId, segmentId, id, container, segmentContainer, deviceProfileId, deviceId, audioCodec, enableAutoStreamCopy, audioSampleRate, audioBitRate, audioChannels, maxAudioChannels, _static, profile, level, framerate, maxFramerate, copyTimestamps, startTimeTicks, width, height, maxWidth, maxHeight, videoBitRate, subtitleStreamIndex, subtitleMethod, maxRefFrames, maxVideoBitDepth, videoCodec, audioStreamIndex, videoStreamIndex, options = {}) => {
            // verify required parameter 'playlistId' is not null or undefined
            if (playlistId === null || playlistId === undefined) {
                throw new base_1.RequiredError("playlistId", "Required parameter playlistId was null or undefined when calling getVideosByIdHlsByPlaylistidBySegmentidBySegmentcontainer.");
            }
            // verify required parameter 'segmentId' is not null or undefined
            if (segmentId === null || segmentId === undefined) {
                throw new base_1.RequiredError("segmentId", "Required parameter segmentId was null or undefined when calling getVideosByIdHlsByPlaylistidBySegmentidBySegmentcontainer.");
            }
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
                throw new base_1.RequiredError("id", "Required parameter id was null or undefined when calling getVideosByIdHlsByPlaylistidBySegmentidBySegmentcontainer.");
            }
            // verify required parameter 'container' is not null or undefined
            if (container === null || container === undefined) {
                throw new base_1.RequiredError("container", "Required parameter container was null or undefined when calling getVideosByIdHlsByPlaylistidBySegmentidBySegmentcontainer.");
            }
            // verify required parameter 'segmentContainer' is not null or undefined
            if (segmentContainer === null || segmentContainer === undefined) {
                throw new base_1.RequiredError("segmentContainer", "Required parameter segmentContainer was null or undefined when calling getVideosByIdHlsByPlaylistidBySegmentidBySegmentcontainer.");
            }
         ...
         * @throws {RequiredError}
         */
        getVideosByIdLiveM3u8: async (id, container, deviceProfileId, deviceId, audioCodec, enableAutoStreamCopy, audioSampleRate, audioBitRate, audioChannels, maxAudioChannels, _static, profile, level, framerate, maxFramerate, copyTimestamps, startTimeTicks, width, height, maxWidth, maxHeight, videoBitRate, subtitleStreamIndex, subtitleMethod, maxRefFrames, maxVideoBitDepth, videoCodec, audioStreamIndex, videoStreamIndex, options = {}) => {
            // verify required parameter 'id' is not null or undefined
            if (id === null || id === undefined) {
                throw new base_1.RequiredError("id", "Required parameter id was null or undefined when calling getVideosByIdLiveM3u8.");
            }
            // verify required parameter 'container' is not null or undefined
            if (container === null || container === undefined) {
                throw new base_1.RequiredError("container", "Required parameter container was null or undefined when calling getVideosByIdLiveM3u8.");
            }
            const localVarPath = `/Videos/{Id}/live.m3u8`.replace(`{${"Id"}}`, encodeURIComponent(String(id)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, "https://example.com");
            let baseOptions;
            if (configuration) {
...
exports.VideoHlsServiceApiAxiosParamCreator = VideoHlsServiceApiAxiosParamCreator;
/**
 * VideoHlsServiceApi - functional programming interface
 * @export
 */
const VideoHlsServiceApiFp = function (configuration) {
    return {
        /**
         * No authentication required
         * @param {string} playlistId
         ...
         * @throws {RequiredError}
         */
        async getVideosByIdLiveM3u8(id, container, deviceProfileId, deviceId, audioCodec, enableAutoStreamCopy, audioSampleRate, audioBitRate, audioChannels, maxAudioChannels, _static, profile, level, framerate, maxFramerate, copyTimestamps, startTimeTicks, width, height, maxWidth, maxHeight, videoBitRate, subtitleStreamIndex, subtitleMethod, maxRefFrames, maxVideoBitDepth, videoCodec, audioStreamIndex, videoStreamIndex, options) {
            const localVarAxiosArgs = await (0, exports.VideoHlsServiceApiAxiosParamCreator)(configuration).getVideosByIdLiveM3u8(id, container, deviceProfileId, deviceId, audioCodec, enableAutoStreamCopy, audioSampleRate, audioBitRate, audioChannels, maxAudioChannels, _static, profile, level, framerate, maxFramerate, copyTimestamps, startTimeTicks, width, height, maxWidth, maxHeight, videoBitRate, subtitleStreamIndex, subtitleMethod, maxRefFrames, maxVideoBitDepth, videoCodec, audioStreamIndex, videoStreamIndex, options);
            return (axios = axios_1.default, basePath = base_1.BASE_PATH) => {
                const axiosRequestArgs = Object.assign(Object.assign({}, localVarAxiosArgs.options), { url: basePath + localVarAxiosArgs.url });
                return axios.request(axiosRequestArgs);
            };
...
exports.VideoHlsServiceApiFp = VideoHlsServiceApiFp;
/**
 * VideoHlsServiceApi - factory interface
 * @export
 */
const VideoHlsServiceApiFactory = function (configuration, basePath, axios) {
    return {
        /**
         * No authentication required
         * @param {string} playlistId
         ...
         * @throws {RequiredError}
         */
        getVideosByIdHlsByPlaylistidBySegmentidBySegmentcontainer(playlistId, segmentId, id, container, segmentContainer, deviceProfileId, deviceId, audioCodec, enableAutoStreamCopy, audioSampleRate, audioBitRate, audioChannels, maxAudioChannels, _static, profile, level, framerate, maxFramerate, copyTimestamps, startTimeTicks, width, height, maxWidth, maxHeight, videoBitRate, subtitleStreamIndex, subtitleMethod, maxRefFrames, maxVideoBitDepth, videoCodec, audioStreamIndex, videoStreamIndex, options) {
            return (0, exports.VideoHlsServiceApiFp)(configuration)
                .getVideosByIdHlsByPlaylistidBySegmentidBySegmentcontainer(playlistId, segmentId, id, container, segmentContainer, deviceProfileId, deviceId, audioCodec, enableAutoStreamCopy, audioSampleRate, audioBitRate, audioChannels, maxAudioChannels, _static, profile, level, framerate, maxFramerate, copyTimestamps, startTimeTicks, width, height, maxWidth, maxHeight, videoBitRate, subtitleStreamIndex, subtitleMethod, maxRefFrames, maxVideoBitDepth, videoCodec, audioStreamIndex, videoStreamIndex, options)
...
exports.VideoHlsServiceApiFactory = VideoHlsServiceApiFactory;
/**
 * VideoHlsServiceApi - object-oriented interface
 * @export
 * @class VideoHlsServiceApi
 * @extends {BaseAPI}
 */
class VideoHlsServiceApi extends base_1.BaseAPI {
    /**
     * No authentication required
     * @param {string} playlistId
     * @param {string} segmentId SegmentId
     ...
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof VideoHlsServiceApi
     */
    getVideosByIdHlsByPlaylistidBySegmentidBySegmentcontainer(playlistId, segmentId, id, container, segmentContainer, deviceProfileId, deviceId, audioCodec, enableAutoStreamCopy, audioSampleRate, audioBitRate, audioChannels, maxAudioChannels, _static, profile, level, framerate, maxFramerate, copyTimestamps, startTimeTicks, width, height, maxWidth, maxHeight, videoBitRate, subtitleStreamIndex, subtitleMethod, maxRefFrames, maxVideoBitDepth, videoCodec, audioStreamIndex, videoStreamIndex, options) {
        return (0, exports.VideoHlsServiceApiFp)(this.configuration)
            .getVideosByIdHlsByPlaylistidBySegmentidBySegmentcontainer(playlistId, segmentId, id, container, segmentContainer, deviceProfileId, deviceId, audioCodec, enableAutoStreamCopy, audioSampleRate, audioBitRate, audioChannels, maxAudioChannels, _static, profile, level, framerate, maxFramerate, copyTimestamps, startTimeTicks, width, height, maxWidth, maxHeight, videoBitRate, subtitleStreamIndex, subtitleMethod, maxRefFrames, maxVideoBitDepth, videoCodec, audioStreamIndex, videoStreamIndex, options)
...
exports.VideoHlsServiceApi = VideoHlsServiceApi;
//# sourceMappingURL=video-hls-service-api.js.map