 ...
 * @export
 */
export const GenresServiceApiAxiosParamCreator = function (
    ...
    getGenresByName: async (
      ...
      if (name === null || name === undefined) {
        throw new RequiredError(
          "name",
          "Required parameter name was null or undefined when calling getGenresByName."
        );
      }
      const localVarPath = `/Genres/{Name}`.replace(
        `{${"Name"}}`,
 ...
 * @export
 */
export const GenresServiceApiFp = function (configuration?: Configuration) {
  return {
    /**
     * Requires authentication as user
     * @summary Gets all genres from a given item, folder, or the entire library
    ...
    > {
      const localVarAxiosArgs = await GenresServiceApiAxiosParamCreator(
        configuration
      ).getGenres(
        artistType,
        maxOfficialRating,
 ...
 * @export
 */
export const GenresServiceApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  return {
    ...
    getGenres(
      ...
      return GenresServiceApiFp(configuration)
        .getGenres(
          artistType,
          maxOfficialRating,
          hasThemeSong,
 ...
 * @extends {BaseAPI}
 */
export class GenresServiceApi extends BaseAPI {
  /**
   * Requires authentication as user
   * @summary Gets all genres from a given item, folder, or the entire library
   * @param {string} [artistType] Artist or AlbumArtist
  ...
  public getGenres(
    ...
    return GenresServiceApiFp(this.configuration)
      .getGenres(
        artistType,
        maxOfficialRating,
        hasThemeSong,
   ...
   * @memberof GenresServiceApi
   */
  public getGenresByName(name: string, userId?: string, options?: any) {
    return GenresServiceApiFp(this.configuration)
      .getGenresByName(name, userId, options)
      .then((request) => request(this.axios, this.basePath));
  }
