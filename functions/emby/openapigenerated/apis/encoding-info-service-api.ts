 ...
 * @export
 */
export const EncodingInfoServiceApiAxiosParamCreator = function (
  ...
  return {
     ...
     */
    getEncodingCodecconfigurationDefaults: async (
      options: any = {}
    ): Promise<RequestArgs> => {
     ...
     * @throws {RequiredError}
     */
    getEncodingCodecinformationVideo: async (
      options: any = {}
    ): Promise<RequestArgs> => {
     ...
     * @throws {RequiredError}
     */
    getEncodingTonemapoptions: async (
      options: any = {}
    ): Promise<RequestArgs> => {
 ...
 * @export
 */
export const EncodingInfoServiceApiFp = function (
  configuration?: Configuration
) {
  return {
    /**
     ...
     * @throws {RequiredError}
     */
    async getEncodingCodecconfigurationDefaults(
      options?: any
    ): Promise<
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<Array<ConfigurationCodecConfiguration>>
    > {
      const localVarAxiosArgs = await EncodingInfoServiceApiAxiosParamCreator(
        configuration
     ...
     * @throws {RequiredError}
     */
    async getEncodingCodecinformationVideo(
      options?: any
    ): Promise<
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<Array<MediaEncodingCodecsVideoCodecsVideoCodecBase>>
    > {
      const localVarAxiosArgs = await EncodingInfoServiceApiAxiosParamCreator(
        configuration
     ...
     * @throws {RequiredError}
     */
    async getEncodingTonemapoptions(
      options?: any
    ): Promise<
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<MediaEncodingConfigurationToneMappingToneMapOptionsVisibility>
    > {
      const localVarAxiosArgs = await EncodingInfoServiceApiAxiosParamCreator(
        configuration
 ...
 * @export
 */
export const EncodingInfoServiceApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  return {
    ...
    getEncodingCodecconfigurationDefaults(
      ...
      return EncodingInfoServiceApiFp(configuration)
        .getEncodingCodecconfigurationDefaults(options)
...
export class EncodingInfoServiceApi extends BaseAPI {
  ...
  public getEncodingCodecconfigurationDefaults(options?: any) {
    return EncodingInfoServiceApiFp(this.configuration)
      .getEncodingCodecconfigurationDefaults(options)
