 ...
 * @export
 */
export const TrailersServiceApiAxiosParamCreator = function (
...
export const TrailersServiceApiFp = function (configuration?: Configuration) {
  return {
    ...
    > {
      const localVarAxiosArgs = await TrailersServiceApiAxiosParamCreator(
        configuration
      ).getTrailers(
        artistType,
        maxOfficialRating,
 ...
 * @export
 */
export const TrailersServiceApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  return {
    ...
    getTrailers(
      ...
      return TrailersServiceApiFp(configuration)
        .getTrailers(
          artistType,
          maxOfficialRating,
          hasThemeSong,
...
export class TrailersServiceApi extends BaseAPI {
  ...
  public getTrailers(
    ...
    return TrailersServiceApiFp(this.configuration)
      .getTrailers(
        artistType,
        maxOfficialRating,
        hasThemeSong,
