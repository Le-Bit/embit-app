 ...
 * @export
 */
export const ActivityLogServiceApiAxiosParamCreator = function (
  ...
  return {
     ...
     */
    getSystemActivitylogEntries: async (
      startIndex?: number,
      limit?: number,
      minDate?: string,
      options: any = {}
 ...
 * @export
 */
export const ActivityLogServiceApiFp = function (
  configuration?: Configuration
) {
  return {
    /**
     ...
     * @throws {RequiredError}
     */
    async getSystemActivitylogEntries(
      startIndex?: number,
      limit?: number,
      minDate?: string,
      options?: any
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<QueryResultActivityLogEntry>
    > {
      const localVarAxiosArgs = await ActivityLogServiceApiAxiosParamCreator(
        configuration
 ...
 * @export
 */
export const ActivityLogServiceApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  return {
    ...
    getSystemActivitylogEntries(
      ...
      return ActivityLogServiceApiFp(configuration)
        .getSystemActivitylogEntries(startIndex, limit, minDate, options)
...
export class ActivityLogServiceApi extends BaseAPI {
  ...
  public getSystemActivitylogEntries(
    ...
    return ActivityLogServiceApiFp(this.configuration)
      .getSystemActivitylogEntries(startIndex, limit, minDate, options)
