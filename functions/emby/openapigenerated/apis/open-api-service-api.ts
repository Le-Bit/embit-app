 ...
 * @export
 */
export const OpenApiServiceApiAxiosParamCreator = function (
...
export const OpenApiServiceApiFp = function (configuration?: Configuration) {
  return {
    ...
    > {
      const localVarAxiosArgs = await OpenApiServiceApiAxiosParamCreator(
        configuration
      ).getOpenapi(options);
      return (
 ...
 * @export
 */
export const OpenApiServiceApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  return {
    ...
    getOpenapi(options?: any): AxiosPromise<string> {
      return OpenApiServiceApiFp(configuration)
        .getOpenapi(options)
...
export class OpenApiServiceApi extends BaseAPI {
  ...
  public getOpenapi(options?: any) {
    return OpenApiServiceApiFp(this.configuration)
      .getOpenapi(options)
