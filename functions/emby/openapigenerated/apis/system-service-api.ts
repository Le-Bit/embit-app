 ...
 * @export
 */
export const SystemServiceApiAxiosParamCreator = function (
  ...
  return {
    ...
    getSystemLogsByName: async (
      ...
      if (name === null || name === undefined) {
        throw new RequiredError(
          "name",
          "Required parameter name was null or undefined when calling getSystemLogsByName."
        );
      }
      const localVarPath = `/System/Logs/{Name}`.replace(
        `{${"Name"}}`,
     ...
     * @throws {RequiredError}
     */
    getSystemLogsByNameLines: async (
      name: string,
      options: any = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'name' is not null or undefined
      if (name === null || name === undefined) {
        throw new RequiredError(
          "name",
          "Required parameter name was null or undefined when calling getSystemLogsByNameLines."
        );
      }
      const localVarPath = `/System/Logs/{Name}/Lines`.replace(
        `{${"Name"}}`,
        encodeURIComponent(String(name))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
     ...
     * @throws {RequiredError}
     */
    getSystemReleasenotesVersions: async (
      options: any = {}
    ): Promise<RequestArgs> => {
...
export const SystemServiceApiFp = function (configuration?: Configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    async getSystemEndpoint(
      options?: any
    ): Promise<
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<NetEndPointInfo>
    > {
      const localVarAxiosArgs = await SystemServiceApiAxiosParamCreator(
        configuration
     ...
     * @throws {RequiredError}
     */
    async getSystemLogsByNameLines(
      name: string,
      options?: any
    ): Promise<
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<QueryResultString>
    > {
      const localVarAxiosArgs = await SystemServiceApiAxiosParamCreator(
        configuration
    ...
    async getSystemLogsQuery(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<QueryResultLogFile>
    > {
      const localVarAxiosArgs = await SystemServiceApiAxiosParamCreator(
        configuration
     ...
     * @throws {RequiredError}
     */
    async getSystemReleasenotes(
      options?: any
    ): Promise<
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<UpdatesPackageVersionInfo>
    > {
      const localVarAxiosArgs = await SystemServiceApiAxiosParamCreator(
        configuration
     ...
     * @throws {RequiredError}
     */
    async getSystemReleasenotesVersions(
      options?: any
    ): Promise<
      (
        axios?: AxiosInstance,
     ...
     * @throws {RequiredError}
     */
    async getSystemWakeonlaninfo(
      options?: any
    ): Promise<
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<Array<WakeOnLanInfo>>
    > {
      const localVarAxiosArgs = await SystemServiceApiAxiosParamCreator(
        configuration
 ...
 * @export
 */
export const SystemServiceApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  return {
    ...
    getSystemEndpoint(options?: any): AxiosPromise<NetEndPointInfo> {
      return SystemServiceApiFp(configuration)
        .getSystemEndpoint(options)
...
export class SystemServiceApi extends BaseAPI {
  ...
  public getSystemEndpoint(options?: any) {
    return SystemServiceApiFp(this.configuration)
      .getSystemEndpoint(options)
