 ...
 * @export
 */
export const TvShowsServiceApiAxiosParamCreator = function (
  ...
  return {
    ...
    getShowsByIdEpisodes: async (
      ...
      if (id === null || id === undefined) {
        throw new RequiredError(
          "id",
          "Required parameter id was null or undefined when calling getShowsByIdEpisodes."
        );
      }
      const localVarPath = `/Shows/{Id}/Episodes`.replace(
        `{${"Id"}}`,
    ...
    getShowsByIdSeasons: async (
      ...
      if (userId === null || userId === undefined) {
        throw new RequiredError(
          "userId",
          "Required parameter userId was null or undefined when calling getShowsByIdSeasons."
        );
      }
      // verify required parameter 'id' is not null or undefined
      if (id === null || id === undefined) {
        throw new RequiredError(
          "id",
          "Required parameter id was null or undefined when calling getShowsByIdSeasons."
        );
      }
      const localVarPath = `/Shows/{Id}/Seasons`.replace(
        `{${"Id"}}`,
        encodeURIComponent(String(id))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    getShowsNextup: async (
      ...
      if (userId === null || userId === undefined) {
        throw new RequiredError(
          "userId",
          "Required parameter userId was null or undefined when calling getShowsNextup."
        );
      }
    ...
    getShowsUpcoming: async (
      ...
      if (userId === null || userId === undefined) {
        throw new RequiredError(
          "userId",
          "Required parameter userId was null or undefined when calling getShowsUpcoming."
        );
      }
...
export const TvShowsServiceApiFp = function (configuration?: Configuration) {
  return {
    ...
    > {
      const localVarAxiosArgs = await TvShowsServiceApiAxiosParamCreator(
        configuration
 ...
 * @export
 */
export const TvShowsServiceApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  return {
    ...
    getShowsByIdEpisodes(
      ...
      return TvShowsServiceApiFp(configuration)
        .getShowsByIdEpisodes(
          id,
          season,
          seasonId,
...
export class TvShowsServiceApi extends BaseAPI {
  ...
  public getShowsByIdEpisodes(
    ...
    return TvShowsServiceApiFp(this.configuration)
      .getShowsByIdEpisodes(
        id,
        season,
        seasonId,
