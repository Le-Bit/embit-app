 ...
 * @export
 */
export const MusicGenresServiceApiAxiosParamCreator = function (
    ...
    getMusicgenresByName: async (
      ...
      if (name === null || name === undefined) {
        throw new RequiredError(
          "name",
          "Required parameter name was null or undefined when calling getMusicgenresByName."
        );
      }
      const localVarPath = `/MusicGenres/{Name}`.replace(
        `{${"Name"}}`,
 ...
 * @export
 */
export const MusicGenresServiceApiFp = function (
  configuration?: Configuration
) {
  return {
    /**
    ...
    > {
      const localVarAxiosArgs = await MusicGenresServiceApiAxiosParamCreator(
        configuration
      ).getMusicgenres(
        artistType,
        maxOfficialRating,
 ...
 * @export
 */
export const MusicGenresServiceApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  return {
    ...
    getMusicgenres(
      ...
      return MusicGenresServiceApiFp(configuration)
        .getMusicgenres(
          artistType,
          maxOfficialRating,
          hasThemeSong,
 ...
 * @extends {BaseAPI}
 */
export class MusicGenresServiceApi extends BaseAPI {
  /**
   * Requires authentication as user
   * @summary Gets all music genres from a given item, folder, or the entire library
   * @param {string} [artistType] Artist or AlbumArtist
  ...
  public getMusicgenres(
    ...
    return MusicGenresServiceApiFp(this.configuration)
      .getMusicgenres(
        artistType,
        maxOfficialRating,
        hasThemeSong,
   ...
   * @memberof MusicGenresServiceApi
   */
  public getMusicgenresByName(name: string, userId?: string, options?: any) {
    return MusicGenresServiceApiFp(this.configuration)
      .getMusicgenresByName(name, userId, options)
      .then((request) => request(this.axios, this.basePath));
  }
