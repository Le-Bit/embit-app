 ...
 * @export
 */
export const UserViewsServiceApiAxiosParamCreator = function (
    ...
    getUsersByUseridViews: async (
      ...
      if (userId === null || userId === undefined) {
        throw new RequiredError(
          "userId",
          "Required parameter userId was null or undefined when calling getUsersByUseridViews."
        );
      }
      // verify required parameter 'includeExternalContent' is not null or undefined
      if (
        includeExternalContent === null ||
        includeExternalContent === undefined
      ) {
        throw new RequiredError(
          "includeExternalContent",
          "Required parameter includeExternalContent was null or undefined when calling getUsersByUseridViews."
        );
      }
      const localVarPath = `/Users/{UserId}/Views`.replace(
        `{${"UserId"}}`,
...
export const UserViewsServiceApiFp = function (configuration?: Configuration) {
  return {
    ...
    > {
      const localVarAxiosArgs = await UserViewsServiceApiAxiosParamCreator(
        configuration
 ...
 * @export
 */
export const UserViewsServiceApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  return {
    ...
    getUsersByUseridViews(
      ...
      return UserViewsServiceApiFp(configuration)
        .getUsersByUseridViews(userId, includeExternalContent, options)
...
export class UserViewsServiceApi extends BaseAPI {
  ...
  public getUsersByUseridViews(
    ...
    return UserViewsServiceApiFp(this.configuration)
      .getUsersByUseridViews(userId, includeExternalContent, options)
