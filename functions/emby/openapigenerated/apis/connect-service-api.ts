 ...
 * @export
 */
export const ConnectServiceApiAxiosParamCreator = function (
  ...
  return {
     ...
     */
    deleteUsersByIdConnectLink: async (
      id: string,
      options: any = {}
    ): Promise<RequestArgs> => {
      ...
      if (id === null || id === undefined) {
        throw new RequiredError(
          "id",
          "Required parameter id was null or undefined when calling deleteUsersByIdConnectLink."
        );
      }
      const localVarPath = `/Users/{Id}/Connect/Link`.replace(
        `{${"Id"}}`,
    ...
    getConnectExchange: async (
      ...
      if (connectUserId === null || connectUserId === undefined) {
        throw new RequiredError(
          "connectUserId",
          "Required parameter connectUserId was null or undefined when calling getConnectExchange."
        );
      }
     ...
     * @throws {RequiredError}
     */
    postUsersByIdConnectLink: async (
      id: string,
      ...
      if (id === null || id === undefined) {
        throw new RequiredError(
          "id",
          "Required parameter id was null or undefined when calling postUsersByIdConnectLink."
        );
      }
      ...
      if (connectUsername === null || connectUsername === undefined) {
        throw new RequiredError(
          "connectUsername",
          "Required parameter connectUsername was null or undefined when calling postUsersByIdConnectLink."
        );
      }
      const localVarPath = `/Users/{Id}/Connect/Link`.replace(
        `{${"Id"}}`,
...
export const ConnectServiceApiFp = function (configuration?: Configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    async deleteUsersByIdConnectLink(
      id: string,
      options?: any
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>
    > {
      const localVarAxiosArgs = await ConnectServiceApiAxiosParamCreator(
        configuration
    ...
    async getConnectExchange(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<ConnectConnectAuthenticationExchangeResult>
    > {
      const localVarAxiosArgs = await ConnectServiceApiAxiosParamCreator(
        configuration
     ...
     * @throws {RequiredError}
     */
    async postUsersByIdConnectLink(
      id: string,
      connectUsername: string,
      options?: any
    ): Promise<
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<ConnectUserLinkResult>
    > {
      const localVarAxiosArgs = await ConnectServiceApiAxiosParamCreator(
        configuration
 ...
 * @export
 */
export const ConnectServiceApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  return {
    ...
    deleteUsersByIdConnectLink(id: string, options?: any): AxiosPromise<void> {
      return ConnectServiceApiFp(configuration)
        .deleteUsersByIdConnectLink(id, options)
...
export class ConnectServiceApi extends BaseAPI {
  ...
  public deleteUsersByIdConnectLink(id: string, options?: any) {
    return ConnectServiceApiFp(this.configuration)
      .deleteUsersByIdConnectLink(id, options)
