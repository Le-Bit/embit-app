 ...
 * @export
 */
export const TagServiceApiAxiosParamCreator = function (
    ...
    postItemsByIdTagsAdd: async (
      ...
      if (body === null || body === undefined) {
        throw new RequiredError(
          "body",
          "Required parameter body was null or undefined when calling postItemsByIdTagsAdd."
        );
      }
      ...
      if (id === null || id === undefined) {
        throw new RequiredError(
          "id",
          "Required parameter id was null or undefined when calling postItemsByIdTagsAdd."
        );
      }
      const localVarPath = `/Items/{Id}/Tags/Add`.replace(
        `{${"Id"}}`,
  ...
  return {
    ...
    async getArtistsPrefixes(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<Array<NameValuePair>>
    > {
      const localVarAxiosArgs = await TagServiceApiAxiosParamCreator(
        configuration
      ).getArtistsPrefixes(
        artistType,
        maxOfficialRating,
    ...
    async getAudiocodecs(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<QueryResultUserLibraryTagItem>
    > {
      const localVarAxiosArgs = await TagServiceApiAxiosParamCreator(
        configuration
      ).getAudiocodecs(
 ...
 * @export
 */
export const TagServiceApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  return {
    ...
    getArtistsPrefixes(
      ...
      return TagServiceApiFp(configuration)
        .getArtistsPrefixes(
          artistType,
          maxOfficialRating,
          hasThemeSong,
...
export class TagServiceApi extends BaseAPI {
  ...
  public getArtistsPrefixes(
    ...
    return TagServiceApiFp(this.configuration)
      .getArtistsPrefixes(
        artistType,
        maxOfficialRating,
        hasThemeSong,
