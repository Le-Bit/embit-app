 ...
 * @export
 */
export const CollectionServiceApiAxiosParamCreator = function (
  ...
  return {
     ...
     */
    deleteCollectionsByIdItems: async (
      ids: string,
      id: string,
      options: any = {}
    ): Promise<RequestArgs> => {
      ...
      if (ids === null || ids === undefined) {
        throw new RequiredError(
          "ids",
          "Required parameter ids was null or undefined when calling deleteCollectionsByIdItems."
        );
      }
      ...
      if (id === null || id === undefined) {
        throw new RequiredError(
          "id",
          "Required parameter id was null or undefined when calling deleteCollectionsByIdItems."
        );
      }
      const localVarPath = `/Collections/{Id}/Items`.replace(
        `{${"Id"}}`,
     ...
     * @throws {RequiredError}
     */
    postCollectionsByIdItems: async (
      ids: string,
      id: string,
      options: any = {}
    ): Promise<RequestArgs> => {
      ...
      if (ids === null || ids === undefined) {
        throw new RequiredError(
          "ids",
          "Required parameter ids was null or undefined when calling postCollectionsByIdItems."
        );
      }
      // verify required parameter 'id' is not null or undefined
      if (id === null || id === undefined) {
        throw new RequiredError(
          "id",
          "Required parameter id was null or undefined when calling postCollectionsByIdItems."
        );
      }
      const localVarPath = `/Collections/{Id}/Items`.replace(
        `{${"Id"}}`,
...
export const CollectionServiceApiFp = function (configuration?: Configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    async deleteCollectionsByIdItems(
      ids: string,
      id: string,
      options?: any
    ): Promise<
    ...
    > {
      const localVarAxiosArgs = await CollectionServiceApiAxiosParamCreator(
        configuration
    ...
    async postCollections(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<CollectionsCollectionCreationResult>
    > {
      const localVarAxiosArgs = await CollectionServiceApiAxiosParamCreator(
        configuration
     ...
     * @throws {RequiredError}
     */
    async postCollectionsByIdItems(
      ids: string,
      id: string,
      options?: any
    ): Promise<
 ...
 * @export
 */
export const CollectionServiceApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  return {
    ...
    deleteCollectionsByIdItems(
      ...
      return CollectionServiceApiFp(configuration)
        .deleteCollectionsByIdItems(ids, id, options)
...
export class CollectionServiceApi extends BaseAPI {
  ...
  public deleteCollectionsByIdItems(ids: string, id: string, options?: any) {
    return CollectionServiceApiFp(this.configuration)
      .deleteCollectionsByIdItems(ids, id, options)
