 ...
 * @export
 */
export const PersonsServiceApiAxiosParamCreator = function (
    ...
    getPersonsByName: async (
      ...
      if (name === null || name === undefined) {
        throw new RequiredError(
          "name",
          "Required parameter name was null or undefined when calling getPersonsByName."
        );
      }
      const localVarPath = `/Persons/{Name}`.replace(
        `{${"Name"}}`,
 ...
 * @export
 */
export const PersonsServiceApiFp = function (configuration?: Configuration) {
  return {
    /**
     * Requires authentication as user
     * @summary Gets all persons from a given item, folder, or the entire library
    ...
    > {
      const localVarAxiosArgs = await PersonsServiceApiAxiosParamCreator(
        configuration
      ).getPersons(
        artistType,
        maxOfficialRating,
 ...
 * @export
 */
export const PersonsServiceApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  return {
    ...
    getPersons(
      ...
      return PersonsServiceApiFp(configuration)
        .getPersons(
          artistType,
          maxOfficialRating,
          hasThemeSong,
 ...
 * @extends {BaseAPI}
 */
export class PersonsServiceApi extends BaseAPI {
  /**
   * Requires authentication as user
   * @summary Gets all persons from a given item, folder, or the entire library
   * @param {string} [artistType] Artist or AlbumArtist
  ...
  public getPersons(
    ...
    return PersonsServiceApiFp(this.configuration)
      .getPersons(
        artistType,
        maxOfficialRating,
        hasThemeSong,
   ...
   * @memberof PersonsServiceApi
   */
  public getPersonsByName(name: string, userId?: string, options?: any) {
    return PersonsServiceApiFp(this.configuration)
      .getPersonsByName(name, userId, options)
      .then((request) => request(this.axios, this.basePath));
  }
