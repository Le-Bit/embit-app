 ...
 * @export
 */
export const HlsSegmentServiceApiAxiosParamCreator = function (
  ...
  return {
     ...
     */
    deleteVideosActiveencodings: async (
      deviceId: string,
      ...
      if (deviceId === null || deviceId === undefined) {
        throw new RequiredError(
          "deviceId",
          "Required parameter deviceId was null or undefined when calling deleteVideosActiveencodings."
        );
      }
      ...
      if (playSessionId === null || playSessionId === undefined) {
        throw new RequiredError(
          "playSessionId",
          "Required parameter playSessionId was null or undefined when calling deleteVideosActiveencodings."
        );
      }
...
export const HlsSegmentServiceApiFp = function (configuration?: Configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    async deleteVideosActiveencodings(
      deviceId: string,
      playSessionId: string,
      options?: any
    ): Promise<
 ...
 * @export
 */
export const HlsSegmentServiceApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  return {
    ...
    deleteVideosActiveencodings(
      ...
      return HlsSegmentServiceApiFp(configuration)
        .deleteVideosActiveencodings(deviceId, playSessionId, options)
...
export class HlsSegmentServiceApi extends BaseAPI {
  ...
  public deleteVideosActiveencodings(
    ...
    return HlsSegmentServiceApiFp(this.configuration)
      .deleteVideosActiveencodings(deviceId, playSessionId, options)
