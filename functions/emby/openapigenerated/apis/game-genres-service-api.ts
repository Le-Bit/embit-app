 ...
 * @export
 */
export const GameGenresServiceApiAxiosParamCreator = function (
    ...
    getGamegenresByName: async (
      ...
      if (name === null || name === undefined) {
        throw new RequiredError(
          "name",
          "Required parameter name was null or undefined when calling getGamegenresByName."
        );
      }
      const localVarPath = `/GameGenres/{Name}`.replace(
        `{${"Name"}}`,
 ...
 * @export
 */
export const GameGenresServiceApiFp = function (configuration?: Configuration) {
  return {
    /**
     * Requires authentication as user
     * @summary Gets all Game genres from a given item, folder, or the entire library
    ...
    > {
      const localVarAxiosArgs = await GameGenresServiceApiAxiosParamCreator(
        configuration
      ).getGamegenres(
        artistType,
        maxOfficialRating,
 ...
 * @export
 */
export const GameGenresServiceApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  return {
    ...
    getGamegenres(
      ...
      return GameGenresServiceApiFp(configuration)
        .getGamegenres(
          artistType,
          maxOfficialRating,
          hasThemeSong,
 ...
 * @extends {BaseAPI}
 */
export class GameGenresServiceApi extends BaseAPI {
  /**
   * Requires authentication as user
   * @summary Gets all Game genres from a given item, folder, or the entire library
   * @param {string} [artistType] Artist or AlbumArtist
  ...
  public getGamegenres(
    ...
    return GameGenresServiceApiFp(this.configuration)
      .getGamegenres(
        artistType,
        maxOfficialRating,
        hasThemeSong,
   ...
   * @memberof GameGenresServiceApi
   */
  public getGamegenresByName(name: string, userId?: string, options?: any) {
    return GameGenresServiceApiFp(this.configuration)
      .getGamegenresByName(name, userId, options)
      .then((request) => request(this.axios, this.basePath));
  }
