 ...
 * @export
 */
export const ChannelServiceApiAxiosParamCreator = function (
...
export const ChannelServiceApiFp = function (configuration?: Configuration) {
  return {
    ...
    > {
      const localVarAxiosArgs = await ChannelServiceApiAxiosParamCreator(
        configuration
 ...
 * @export
 */
export const ChannelServiceApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  return {
    ...
    getChannels(
      ...
      return ChannelServiceApiFp(configuration)
        .getChannels(userId, startIndex, limit, options)
...
export class ChannelServiceApi extends BaseAPI {
  ...
  public getChannels(
    ...
    return ChannelServiceApiFp(this.configuration)
      .getChannels(userId, startIndex, limit, options)
