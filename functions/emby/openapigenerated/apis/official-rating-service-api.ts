...
import { QueryResultUserLibraryOfficialRatingItem } from "../models";
/**
 * OfficialRatingServiceApi - axios parameter creator
 * @export
 */
export const OfficialRatingServiceApiAxiosParamCreator = function (
 ...
 * @export
 */
export const OfficialRatingServiceApiFp = function (
  configuration?: Configuration
) {
  return {
    /**
    ...
    async getOfficialratings(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<QueryResultUserLibraryOfficialRatingItem>
    > {
      const localVarAxiosArgs = await OfficialRatingServiceApiAxiosParamCreator(
        configuration
      ).getOfficialratings(
        artistType,
        maxOfficialRating,
 ...
 * @export
 */
export const OfficialRatingServiceApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  return {
    ...
    getOfficialratings(
      ...
      return OfficialRatingServiceApiFp(configuration)
        .getOfficialratings(
          artistType,
          maxOfficialRating,
          hasThemeSong,
 ...
 * @extends {BaseAPI}
 */
export class OfficialRatingServiceApi extends BaseAPI {
  /**
   * No authentication required
   * @summary Gets items based on a query.
   * @param {string} [artistType] Artist or AlbumArtist
  ...
  public getOfficialratings(
    ...
    return OfficialRatingServiceApiFp(this.configuration)
      .getOfficialratings(
        artistType,
        maxOfficialRating,
        hasThemeSong,
