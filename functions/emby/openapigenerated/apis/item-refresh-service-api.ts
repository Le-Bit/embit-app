 ...
 * @export
 */
export const ItemRefreshServiceApiAxiosParamCreator = function (
    ...
    postItemsByIdRefresh: async (
      ...
      if (id === null || id === undefined) {
        throw new RequiredError(
          "id",
          "Required parameter id was null or undefined when calling postItemsByIdRefresh."
        );
      }
      const localVarPath = `/Items/{Id}/Refresh`.replace(
        `{${"Id"}}`,
 ...
 * @export
 */
export const ItemRefreshServiceApiFp = function (
  configuration?: Configuration
) {
  return {
    /**
    ...
    > {
      const localVarAxiosArgs = await ItemRefreshServiceApiAxiosParamCreator(
        configuration
 ...
 * @export
 */
export const ItemRefreshServiceApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  return {
    ...
    postItemsByIdRefresh(
      ...
      return ItemRefreshServiceApiFp(configuration)
        .postItemsByIdRefresh(
          id,
          recursive,
          metadataRefreshMode,
...
export class ItemRefreshServiceApi extends BaseAPI {
  ...
  public postItemsByIdRefresh(
    ...
    return ItemRefreshServiceApiFp(this.configuration)
      .postItemsByIdRefresh(
        id,
        recursive,
        metadataRefreshMode,
