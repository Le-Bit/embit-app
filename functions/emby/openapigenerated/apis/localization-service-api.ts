 ...
 * @export
 */
export const LocalizationServiceApiAxiosParamCreator = function (
  ...
  return {
     ...
     */
    getLocalizationCountries: async (
      options: any = {}
    ): Promise<RequestArgs> => {
     ...
     * @throws {RequiredError}
     */
    getLocalizationParentalratings: async (
      options: any = {}
    ): Promise<RequestArgs> => {
 ...
 * @export
 */
export const LocalizationServiceApiFp = function (
  configuration?: Configuration
) {
  return {
    /**
    ...
    async getLocalizationCountries(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<Array<GlobalizationCountryInfo>>
    > {
      const localVarAxiosArgs = await LocalizationServiceApiAxiosParamCreator(
        configuration
     ...
     * @throws {RequiredError}
     */
    async getLocalizationCultures(
      options?: any
    ): Promise<
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<Array<GlobalizationCultureDto>>
    > {
      const localVarAxiosArgs = await LocalizationServiceApiAxiosParamCreator(
        configuration
    ...
    async getLocalizationOptions(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<Array<GlobalizationLocalizatonOption>>
    > {
      const localVarAxiosArgs = await LocalizationServiceApiAxiosParamCreator(
        configuration
     ...
     * @throws {RequiredError}
     */
    async getLocalizationParentalratings(
      options?: any
    ): Promise<
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<Array<ParentalRating>>
    > {
      const localVarAxiosArgs = await LocalizationServiceApiAxiosParamCreator(
        configuration
 ...
 * @export
 */
export const LocalizationServiceApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  return {
    ...
    getLocalizationCountries(
      ...
      return LocalizationServiceApiFp(configuration)
        .getLocalizationCountries(options)
...
export class LocalizationServiceApi extends BaseAPI {
  ...
  public getLocalizationCountries(options?: any) {
    return LocalizationServiceApiFp(this.configuration)
      .getLocalizationCountries(options)
