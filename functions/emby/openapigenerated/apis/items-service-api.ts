 ...
 * @export
 */
export const ItemsServiceApiAxiosParamCreator = function (
  ...
  return {
    ...
    getUsersByUseridItems: async (
      ...
      if (userId === null || userId === undefined) {
        throw new RequiredError(
          "userId",
          "Required parameter userId was null or undefined when calling getUsersByUseridItems."
        );
      }
      const localVarPath = `/Users/{UserId}/Items`.replace(
        `{${"UserId"}}`,
     ...
     * @throws {RequiredError}
     */
    getUsersByUseridItemsResume: async (
      userId: string,
      artistType?: string,
      maxOfficialRating?: string,
      hasThemeSong?: boolean,
      ...
      if (userId === null || userId === undefined) {
        throw new RequiredError(
          "userId",
          "Required parameter userId was null or undefined when calling getUsersByUseridItemsResume."
        );
      }
      const localVarPath = `/Users/{UserId}/Items/Resume`.replace(
        `{${"UserId"}}`,
        encodeURIComponent(String(userId))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
 ...
 * @export
 */
export const ItemsServiceApiFp = function (configuration?: Configuration) {
  return {
    /**
     * Requires authentication as user
     * @summary Gets items based on a query.
    ...
    > {
      const localVarAxiosArgs = await ItemsServiceApiAxiosParamCreator(
        configuration
      ).getItems(
        artistType,
        maxOfficialRating,
     ...
     * @throws {RequiredError}
     */
    async getUsersByUseridItemsResume(
      userId: string,
      artistType?: string,
      maxOfficialRating?: string,
      hasThemeSong?: boolean,
 ...
 * @export
 */
export const ItemsServiceApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  return {
    ...
    getItems(
      ...
      return ItemsServiceApiFp(configuration)
        .getItems(
          artistType,
          maxOfficialRating,
          hasThemeSong,
 ...
 * @extends {BaseAPI}
 */
export class ItemsServiceApi extends BaseAPI {
  /**
   * Requires authentication as user
   * @summary Gets items based on a query.
   * @param {string} [artistType] Artist or AlbumArtist
  ...
  public getItems(
    ...
    return ItemsServiceApiFp(this.configuration)
      .getItems(
        artistType,
        maxOfficialRating,
        hasThemeSong,
   ...
   * @memberof ItemsServiceApi
   */
  public getUsersByUseridItemsResume(
    userId: string,
    artistType?: string,
    maxOfficialRating?: string,
    hasThemeSong?: boolean,
