 ...
 * @export
 */
export const UniversalAudioServiceApiAxiosParamCreator = function (
  ...
  return {
    ...
    getAudioByIdUniversal: async (
      ...
      if (id === null || id === undefined) {
        throw new RequiredError(
          "id",
          "Required parameter id was null or undefined when calling getAudioByIdUniversal."
        );
      }
      const localVarPath = `/Audio/{Id}/universal`.replace(
        `{${"Id"}}`,
    ...
    headAudioByIdUniversal: async (
      ...
      if (id === null || id === undefined) {
        throw new RequiredError(
          "id",
          "Required parameter id was null or undefined when calling headAudioByIdUniversal."
        );
      }
      const localVarPath = `/Audio/{Id}/universal`.replace(
        `{${"Id"}}`,
 ...
 * @export
 */
export const UniversalAudioServiceApiFp = function (
  configuration?: Configuration
) {
  return {
    /**
    ...
    > {
      const localVarAxiosArgs = await UniversalAudioServiceApiAxiosParamCreator(
        configuration
 ...
 * @export
 */
export const UniversalAudioServiceApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  return {
    ...
    getAudioByIdByContainer(
      ...
      return UniversalAudioServiceApiFp(configuration)
        .getAudioByIdByContainer(
          id,
          container,
          deviceId,
...
export class UniversalAudioServiceApi extends BaseAPI {
  ...
  public getAudioByIdByContainer(
    ...
    return UniversalAudioServiceApiFp(this.configuration)
