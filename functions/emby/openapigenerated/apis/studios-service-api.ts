 ...
 * @export
 */
export const StudiosServiceApiAxiosParamCreator = function (
    ...
    getStudiosByName: async (
      ...
      if (name === null || name === undefined) {
        throw new RequiredError(
          "name",
          "Required parameter name was null or undefined when calling getStudiosByName."
        );
      }
      const localVarPath = `/Studios/{Name}`.replace(
        `{${"Name"}}`,
 ...
 * @export
 */
export const StudiosServiceApiFp = function (configuration?: Configuration) {
  return {
    /**
     * Requires authentication as user
     * @summary Gets all studios from a given item, folder, or the entire library
    ...
    > {
      const localVarAxiosArgs = await StudiosServiceApiAxiosParamCreator(
        configuration
      ).getStudios(
        artistType,
        maxOfficialRating,
 ...
 * @export
 */
export const StudiosServiceApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  return {
    ...
    getStudios(
      ...
      return StudiosServiceApiFp(configuration)
        .getStudios(
          artistType,
          maxOfficialRating,
          hasThemeSong,
 ...
 * @extends {BaseAPI}
 */
export class StudiosServiceApi extends BaseAPI {
  /**
   * Requires authentication as user
   * @summary Gets all studios from a given item, folder, or the entire library
   * @param {string} [artistType] Artist or AlbumArtist
  ...
  public getStudios(
    ...
    return StudiosServiceApiFp(this.configuration)
      .getStudios(
        artistType,
        maxOfficialRating,
        hasThemeSong,
   ...
   * @memberof StudiosServiceApi
   */
  public getStudiosByName(name: string, userId?: string, options?: any) {
    return StudiosServiceApiFp(this.configuration)
      .getStudiosByName(name, userId, options)
      .then((request) => request(this.axios, this.basePath));
  }
