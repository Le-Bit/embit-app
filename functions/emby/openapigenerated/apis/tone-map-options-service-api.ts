 ...
 * @export
 */
export const ToneMapOptionsServiceApiAxiosParamCreator = function (
  ...
  return {
     ...
     */
    getEncodingPublictonemapoptions: async (
      options: any = {}
    ): Promise<RequestArgs> => {
     ...
     * @throws {RequiredError}
     */
    postEncodingPublictonemapoptions: async (
      body: Object,
      options: any = {}
    ): Promise<RequestArgs> => {
      ...
      if (body === null || body === undefined) {
        throw new RequiredError(
          "body",
          "Required parameter body was null or undefined when calling postEncodingPublictonemapoptions."
        );
      }
      const localVarPath = `/Encoding/PublicToneMapOptions`;
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
 ...
 * @export
 */
export const ToneMapOptionsServiceApiFp = function (
  configuration?: Configuration
) {
  return {
    /**
     ...
     * @throws {RequiredError}
     */
    async getEncodingPublictonemapoptions(
      options?: any
    ): Promise<
      (
        axios?: AxiosInstance,
    ...
    > {
      const localVarAxiosArgs = await ToneMapOptionsServiceApiAxiosParamCreator(
        configuration
     ...
     * @throws {RequiredError}
     */
    async postEncodingPublictonemapoptions(
      body: Object,
      options?: any
    ): Promise<
 ...
 * @export
 */
export const ToneMapOptionsServiceApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  return {
    ...
    getEncodingPublictonemapoptions(
      ...
      return ToneMapOptionsServiceApiFp(configuration)
        .getEncodingPublictonemapoptions(options)
...
export class ToneMapOptionsServiceApi extends BaseAPI {
  ...
  public getEncodingPublictonemapoptions(options?: any) {
    return ToneMapOptionsServiceApiFp(this.configuration)
      .getEncodingPublictonemapoptions(options)
