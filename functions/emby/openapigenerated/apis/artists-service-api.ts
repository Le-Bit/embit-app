 ...
 * @export
 */
export const ArtistsServiceApiAxiosParamCreator = function (
    ...
    getArtistsByName: async (
      ...
      if (name === null || name === undefined) {
        throw new RequiredError(
          "name",
          "Required parameter name was null or undefined when calling getArtistsByName."
        );
      }
      const localVarPath = `/Artists/{Name}`.replace(
        `{${"Name"}}`,
 ...
 * @export
 */
export const ArtistsServiceApiFp = function (configuration?: Configuration) {
  return {
    /**
     * Requires authentication as user
     * @summary Gets all artists from a given item, folder, or the entire library
    ...
    > {
      const localVarAxiosArgs = await ArtistsServiceApiAxiosParamCreator(
        configuration
      ).getArtists(
        artistType,
        maxOfficialRating,
 ...
 * @export
 */
export const ArtistsServiceApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance
) {
  return {
    ...
    getArtists(
      ...
      return ArtistsServiceApiFp(configuration)
        .getArtists(
          artistType,
          maxOfficialRating,
          hasThemeSong,
 ...
 * @extends {BaseAPI}
 */
export class ArtistsServiceApi extends BaseAPI {
  /**
   * Requires authentication as user
   * @summary Gets all artists from a given item, folder, or the entire library
   * @param {string} [artistType] Artist or AlbumArtist
  ...
  public getArtists(
    ...
    return ArtistsServiceApiFp(this.configuration)
      .getArtists(
        artistType,
        maxOfficialRating,
        hasThemeSong,
   ...
   * @memberof ArtistsServiceApi
   */
  public getArtistsByName(name: string, userId?: string, options?: any) {
    return ArtistsServiceApiFp(this.configuration)
      .getArtistsByName(name, userId, options)
      .then((request) => request(this.axios, this.basePath));
  }
