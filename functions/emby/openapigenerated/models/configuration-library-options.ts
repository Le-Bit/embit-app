...
export interface ConfigurationLibraryOptions {
   ...
   * @memberof ConfigurationLibraryOptions
   */
  ignoreHiddenFiles?: any;
  /**
   *
   * @type {Array&lt;string&gt;}
   * @memberof ConfigurationLibraryOptions
   */
  ignoreFileExtensions?: any;
  /**
   *
   * @type {boolean}
   * @memberof ConfigurationLibraryOptions
   ...
   * @memberof ConfigurationLibraryOptions
   */
  importCollections?: any;
  /**
   *
   * @type {number}
   * @memberof ConfigurationLibraryOptions
   */
  minCollectionItems?: any;
  /**
   *
   * @type {string}
   * @memberof ConfigurationLibraryOptions
   */
  musicFolderStructure?: any;
  /**
   *
   * @type {number}
   * @memberof ConfigurationLibraryOptions
