...
import { OmbiCoreProcessorUpdateModel } from "../models";
/**
...
export const UpdateApiAxiosParamCreator = function (
  ...
  return {
     ...
     */
    apiV1UpdateGet: async (options: any = {}): Promise<RequestArgs> => {
...
export const UpdateApiFp = function (configuration?: Configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    async apiV1UpdateGet(
      options?: any
    ): Promise<
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<OmbiCoreProcessorUpdateModel>
    > {
      const localVarAxiosArgs = await UpdateApiAxiosParamCreator(
        configuration
...
export const UpdateApiFactory = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    apiV1UpdateGet(options?: any): AxiosPromise<OmbiCoreProcessorUpdateModel> {
      return UpdateApiFp(configuration)
        .apiV1UpdateGet(options)
...
export class UpdateApi extends BaseAPI {
   ...
   * @memberof UpdateApi
   */
  public apiV1UpdateGet(options?: any) {
